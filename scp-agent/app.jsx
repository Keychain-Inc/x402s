...
const CHANNEL_ABI = ["function openChannel(address,address,uint256,uint64,uint64,bytes32,uint8) external payable returns (bytes32)","function deposit(bytes32,uint256) external payable","function rebalance(tuple(bytes32,uint256,uint256,uint256,bytes32,uint256,bytes32),bytes32,uint256,bytes) external","function balance(bytes32) external view returns (tuple(uint256,uint256,uint256,uint64,bool))","function getChannel(bytes32) external view returns (tuple(address,address,address,uint64,uint64,uint256,bool,uint64,uint64,uint8))","event ChannelOpened(bytes32 indexed,address indexed,address indexed,address,uint64,uint64)","event Deposited(bytes32 indexed,address indexed,uint256,uint256)","event Rebalanced(bytes32 indexed,bytes32 indexed,uint256,uint256,uint256)"];
